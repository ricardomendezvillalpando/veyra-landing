...
export function Header() {
  ...
  return (
    <>
      ...
      >
        <div className="relative mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-5 md:h-[4.5rem] md:px-8">
          {/* Logo */}
          <Link
            href="#top"
          ...
          >
            <Logo height={18} color={onDark ? "#ffffff" : "#0c1418"} />
          </Link>

          {/* Nav lineal centrado (desktop) */}
          <nav
          ...
          <div className="relative z-10 flex items-center gap-2">
            <a
              href="#interes"
              className={`hidden items-center gap-1.5 rounded-full px-5 py-2.5 text-sm font-semibold transition sm:inline-flex ${
                onDark
            ...
            <a
              href="#interes"
              className={`inline-flex items-center gap-1 rounded-full px-3.5 py-2 text-sm font-semibold transition sm:hidden ${
                onDark
                  ? "bg-white text-ink hover:bg-white/90"
                  : "btn-primary"
              }`}
